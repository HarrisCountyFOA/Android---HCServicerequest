...
public class GoogleMapWithScrollFix extends SupportMapFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle savedInstance) {
        ...
        ((ViewGroup) Objects.requireNonNull(layout)).addView(touchableWrapper, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
