...
public final class ImagePicker {
    ...
    private static final int DEFAULT_MIN_HEIGHT_QUALITY = 450;        // min pixels
    ...
    private static Bitmap getImageResized(Context context, Uri selectedImage) {
        ...
        do {
            ...
            Log.i(TAG, "###########getImageResized = " + i);

            i++;
        } while (bm.getWidth() < minWidthQuality && i < sampleSizes.length);

        final int maxSize = minWidthQuality;
        int outWidth;
        int outHeight;
        ...
        Log.i(TAG, "###########Final bitmap width = " + bm.getWidth() + "\theight: " + bm.getHeight() );
        return bm;
    }
